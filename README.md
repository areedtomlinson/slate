...
### Getting Set Up
 ...
 5. Start the test server: `bundle exec middleman server --port=4568`

You can now see the docs at <http://localhost:4568>. And as you edit `source/index.md`, your server should automatically update! Whoa! That was fast!
